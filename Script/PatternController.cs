...
public class PatternController : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject[] patterns;      //보유 패턴
    [SerializeField]
    private GameObject hpPotion;        //체력회복 오브젝트
    private GameObject currentPattern;  //현재 재생 패턴
    private int[] patternIndexs;        //겹치지 않는 pattern.Length
